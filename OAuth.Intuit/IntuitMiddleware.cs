...
namespace OAuth.Intuit
{
    ...
    /// </summary>
    public class IntuitMiddleware : AuthenticationMiddleware<IntuitOptions>
    {
            ...
            : base(next, options, loggerFactory, encoder)
        {
            ...
            {
                Options.Events = new IntuitEvents();
            }
            if (Options.StateDataFormat == null)
            {
                var dataProtector = dataProtectionProvider.CreateProtector(
                    typeof(IntuitMiddleware).FullName, Options.AuthenticationScheme, "v1");
        ...
        protected override AuthenticationHandler<IntuitOptions> CreateHandler()
        {
            return new IntuitHandler(_httpClient);
        }
    }
